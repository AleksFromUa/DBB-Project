...
| |Х-стика|StaffWare|Lan Docs|Бос-Референт|Lotus Notes|
|-|-|-|-|-|-|
...
## <![if !vml]>![](file:///C:\Users\User\AppData\Local\Temp\msohtmlclip1\01\clip_image002.gif)<![endif]>Підходи до виконання завдань
...
<![if !supportLists]>· <![endif]>Перший рівень полягає у виділенні окремих елементів тексту/документу, наприклад, розділів, абзаців, речень і т. д.

<![if !supportLists]>· <![endif]>Другий рівень полягає у визначенні морфологічних характеристик окремого слова.

<![if !supportLists]>· <![endif]>Третій рівень відповідає за визначення синтаксичної залежності слів у реченнях.

<![if !supportLists]>· <![endif]>Четвертий рівень пов'язаний зі смисловим розумінням тексту, що включає розробки у сфері штучного інтелекту.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MDU3OTcwNjIsMTY0NTAzOTAwNSwtOT
U2ODY2Mjg1LDE2MjQ3NjIwOTEsLTE3NDQzOTA3OCwtNjk4NzQ5
MTgzLC0xMjEwNTI5MjIyLDU1OTcwNzk0NSwxNjkyNjI3NTY3XX
0=
-->